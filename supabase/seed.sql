...
insert into doctors(slug,name,designation,qualifications,experience_years,gender,languages,image_url,registration_verified,status)
select 'demo-doctor-'||n,'Dr '||(array['Aarav Sharma','Ananya Rao','Vikram Mehta','Meera Kulkarni','Arjun Shah','Sana Khan','Rohan Iyer','Kavya Nair','Aditya Joshi','Ishita Deshmukh','Rahul Menon','Nandini Patil','Kabir Malhotra','Aditi Verma','Siddharth Bose','Zoya Mirza','Karan Bhatia','Neha Reddy','Varun Kapoor','Ritika Sen','Abhinav Gupta','Tara Pillai','Sameer Sheikh','Priya Chavan','Nikhil Anand','Diya Banerjee','Manav Sethi','Rhea Thomas','Yash Tiwari','Aisha Qureshi','Devendra More','Pooja Narang','Harsh Vardhan','Shreya Naik','Neil Dsouza','Fatima Ansari','Akash Trivedi','Maya Subramanian','Omkar Jadhav','Leena Suri'])[n],'Demo Consultant, '||(array['Cardiac Sciences','Neurosciences','Orthopaedics','Oncology','Gastroenterology'])[1+((n-1)%5)],array['Demo credentials — verification required'],5+(n%20),case when n%2=0 then 'Female' else 'Male' end,array['English','Hindi'],'/images/doctor-'||lpad((((n-1)%6)+1)::text,2,'0')||'.jpg',false,'published' from generate_series(1,40)n;
